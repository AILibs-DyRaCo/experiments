...
//	
//	static double[] dataset12Features = { 0.7207469444444443, 0.8065, 0.10388888888888889, 0.9943208333333334, 0.0535, 0.9405555555555556, 0.9741918055555554, 0.0465, 0.9483333333333334, 0.7207469444444443, 0.8065,
...
//	
//	static double[] dataset36Features = { 0.7749482924482924, 0.7155844155844155, 0.16515151515151513, 0.9727294590930956, 0.16493506493506493, 0.8075757575757576, 0.9706962481962482, 0.049783549783549784,
...
//				+ optimized.getDouble(optimized.length()-2) + ", " 
//				+ optimized.getDouble(optimized.length()-1));
//		double L_exp = optimized.getDouble(optimized.length()-3) * (0.0 - (-4.0)) + (-4.0);
//		double M_exp = optimized.getDouble(optimized.length()-2) * (0.0 - (-4.0)) + (-4.0);
//		double N = optimized.getDouble(optimized.length()-1) * (2000.0 - (10.0)) + (10.0);
//		System.out.println("Denormalized: L_exp = " + L_exp + ", M_exp = " + M_exp +", N = " + N);
//	}
//}
