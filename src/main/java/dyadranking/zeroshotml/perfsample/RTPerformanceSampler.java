...
import dyadranking.zeroshotml.perfsample.classifiersuppliers.RTSupplier;
...
public class RTPerformanceSampler {
	...
	public static void main(String[] args) {
		IRTPerformanceSamplerConfig m = ConfigCache.getOrCreate(IRTPerformanceSamplerConfig.class);
		...
		IClassifierSupplier clsSup = new RTSupplier();
