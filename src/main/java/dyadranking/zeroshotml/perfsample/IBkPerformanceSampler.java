...
public class IBkPerformanceSampler {
	...
	public static void main(String[] args) {
		IBkPerformanceSamplerConfig m = ConfigCache.getOrCreate(IBkPerformanceSamplerConfig.class);
		...
		IClassifierSupplier clsSup = new IBkSupplier();
