...
import dyadranking.zeroshotml.perfsample.classifiersuppliers.REPSupplier;
...
public class REPPerformanceSampler {
	...
	public static void main(String[] args) {
		IREPPerformanceSamplerConfig m = ConfigCache.getOrCreate(IREPPerformanceSamplerConfig.class);
		...
		IClassifierSupplier clsSup = new REPSupplier();
